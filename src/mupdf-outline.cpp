...
Outline::Outline(OutlinePrivate *outlinep) : d(outlinep) {}
...
OutlineItem::OutlineItem() : d(NULL) {}
 ...
 */
OutlineItem::OutlineItem(OutlineItemPrivate *itemp) : d(itemp) {}
...
OutlineItem::~OutlineItem() { delete d; }

OutlineItemPrivate::OutlineItemPrivate(fz_outline *o) : outline(o) {
...
OutlineItemPrivate::~OutlineItemPrivate() { delete link; }

/**
 * @brief Whether this item is valid or not.
 */
bool OutlineItem::isValid() const { return d ? true : false; }
 ...
 * @sa isValid()
 */
QString OutlineItem::title() const { return d->outline->title; }
 ...
 * @sa isValid()
 */
Link *OutlineItem::link() const { return d->link; }
